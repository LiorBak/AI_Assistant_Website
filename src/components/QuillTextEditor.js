...
/**
 * CustomToolbar
 * Defines the Quill toolbar UI, including an optional "LLM Assistant" button (used for the ButtonPress condition only).
 */
const CustomToolbar = ({ showAI, onOpenChat }) => (
  <div id="toolbar" className="ql-toolbar ql-snow">
    ...
    <span className="ql-formats">
      ...
      {/* Show LLM Assistant button only when showAI=true */}
      {showAI && (
        <button
          type="button"
          className="ql-ai"
